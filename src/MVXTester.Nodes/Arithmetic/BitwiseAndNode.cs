...
[NodeInfo("Bitwise AND", NodeCategories.Arithmetic, Description = "Bitwise AND of two images")]
public class BitwiseAndNode : BaseNode
{
    ...
    public override void Process()
    {
        ...
        {
            Error = $"Bitwise AND error: {ex.Message}";
        }
    }
}
