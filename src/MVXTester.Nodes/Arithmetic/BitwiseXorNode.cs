...
[NodeInfo("Bitwise XOR", NodeCategories.Arithmetic, Description = "Bitwise XOR of two images")]
public class BitwiseXorNode : BaseNode
{
    ...
    public override void Process()
    {
        try
        {
            ...
            var result = new Mat();
            Cv2.BitwiseXor(image1, image2, result);
        ...
        {
            Error = $"Bitwise XOR error: {ex.Message}";
        }
    }
}
