...
[NodeInfo("Dilate", NodeCategories.Morphology, Description = "Dilate morphological operation")]
public class DilateNode : BaseNode
{
    ...
    public override void Process()
    {
        try
        {
            ...
            var result = new Mat();
            Cv2.Dilate(image, result, kernel, iterations: iterations);
