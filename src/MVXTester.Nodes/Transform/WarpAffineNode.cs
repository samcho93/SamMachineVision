...
[NodeInfo("Warp Affine", NodeCategories.Transform, Description = "Apply affine transformation using 3 point pairs")]
public class WarpAffineNode : BaseNode
{
    ...
    protected override void Setup()
    {
        ...
        _srcX2 = AddIntProperty("SrcX2", "Src X2", 0, 0, 10000);
        ...
        _dstX2 = AddIntProperty("DstX2", "Dst X2", 10, 0, 10000);
    ...
    public override void Process()
    {
        try
        {
            ...
            var matrix = Cv2.GetAffineTransform(srcPoints, dstPoints);
            var result = new Mat();
        ...
        {
            Error = $"Warp Affine error: {ex.Message}";
        }
    }
}
